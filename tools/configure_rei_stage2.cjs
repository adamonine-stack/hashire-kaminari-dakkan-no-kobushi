...
clip('punch punch_1 light_attack',[12,13,14,0],12);clip('punch_2',[15,16,17,0],12);
clip('kick kick_1 kick_2 combo_finisher heavy_attack',[18,19,20,0],10);
...
clip('special_startup',[32],6);clip('special special_attack rei_dragon_uppercut',[16],8);clip('special_recovery',[17,0],8);
